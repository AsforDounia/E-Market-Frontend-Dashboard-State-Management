...
describe("Product Integration Tests", () => {
    ...
    describe("GET /products", () => {
        ...
        it("should get all products with pagination", async function () {
            ...
            const res = await request(app).get("/api/v2/products").query({ page: 1, limit: 1 });
        ...
        it("should filter products by price range", async function () {
            ...
            const res = await request(app).get("/api/v2/products").query({ minPrice, maxPrice });
        ...
        it("should search products by title", async function () {
            ...
            const res = await request(app).get("/api/v2/products").query({ search: searchTerm });
